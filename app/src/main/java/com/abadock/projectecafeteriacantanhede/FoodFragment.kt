...
import com.abadock.projectecafeteriacantanhede.ViewModel.FoodViewModel
import com.abadock.projectecafeteriacantanhede.data.FoodData
import com.abadock.projectecafeteriacantanhede.data.FoodType
import com.abadock.projectecafeteriacantanhede.databinding.FragmentFoodBinding
...
class FoodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentFoodBinding.inflate(inflater)

        binding.recyclerView.layoutManager = GridLayoutManager(context,2)
        binding.recyclerView.adapter = FoodAdapter(FoodData.loadFood().filter { it.type == FoodType.MENJAR}, cartviewModel)
